...
const SpecificationItem: React.FC<SpecificationItemProps> = ({ 
  ...
  return (
    <div className="grid grid-cols-7 px-4 py-3 hover:bg-slate-50 transition-colors">
      ...
      {/* Left laptop value - Use green for winning indicator and red for losing text */}
          ...
          <span className={
            leftStatus === 'better' 
              ...
              : leftStatus === 'worse' 
                ...
                : ''
          }>{section.leftValue}</span>
          <ExternalLink className="w-3 h-3 opacity-0 group-hover:opacity-60 transition-opacity" />
        </a>
      </div>
      
      {/* Right laptop value - Use green for winning indicator and red for losing text */}
      <div className="col-span-2 text-left">
        <a 
