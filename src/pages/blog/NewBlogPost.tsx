    ...
    <div className="min-h-screen pb-16">
      ...
      <div className="pt-20 container mx-auto px-4 mt-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <div className="mt-6 space-y-2">
                    <h3 className="text-sm font-medium">Tips for {selectedCategory} Posts</h3>
          ...
          {/* Right Column: Content Editor and Metadata */}
          <div className="lg:col-span-2 space-y-8">
            {!content ? (
              ...
              <>
                ...
                <Card>
                  <CardHeader className="pb-3">
                    <CardTitle className="text-xl">Settings & SEO</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <PostMetadata 
                      post={previewPost}
