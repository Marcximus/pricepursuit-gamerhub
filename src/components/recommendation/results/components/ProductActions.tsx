    ...
    <div className="flex flex-col space-y-3">
      {productUrl ? (
        <Button 
          ...
          className="w-full bg-green-600 hover:bg-green-700 transform hover:-translate-y-0.5 transition-all"
        >
          Check it out
        ...
        <Button
          variant="outline"
          className="w-full hover:border-green-500 hover:text-green-600 transform hover:-translate-y-0.5 transition-all"
