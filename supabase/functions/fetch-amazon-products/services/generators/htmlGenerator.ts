    ...
    <div class="product-card" data-asin="${escapeHtml(product.asin)}" data-rank="${rank}">
      ...
      <div class="product-details">
        ...
        <div class="product-cta">
          <a href="${escapeHtml(product.url)}" class="check-price-btn button-amazon bg-amber-500 hover:bg-amber-600 text-white font-semibold py-2 px-4 rounded inline-block transition-colors duration-200" target="_blank" rel="nofollow noopener">Check It Out Now</a>
        </div>
      </div>
    </div>
  `;
